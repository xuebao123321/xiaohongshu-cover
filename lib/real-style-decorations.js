        ...
        case 'sticker':
          ...
          if (params.stickerId) {
            try {
              ...
              // 回退: Canvas 手绘贴纸 + 贴纸感包装
              if (!drawn && typeof window.renderAsSticker === 'function' && window._drawStickerFns) {
