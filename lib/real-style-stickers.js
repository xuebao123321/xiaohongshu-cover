...
const REAL_STYLE_STICKER_POOL = {
  handnote: {
    categories: ['stationery', 'doodle', 'texture', 'decor', 'animal', 'character', 'food', 'plant'],
    preferred: [
      ...
      'fullBodyCat', 'fullBodyDog', 'coffeeCup', 'flower', 'clover',
    ],
    maxEmoji: 2,
    maxDoodle: 3,
  },
  ...
  collage: {
    categories: ['stationery', 'stamp', 'frame', 'decor', 'texture', 'character', 'animal', 'food', 'plant'],
    preferred: [
      'stickyNote', 'polaroidFrame', 'indexTab',
      'realisticStamp', 'washiTape',
      'handDrawnArrow', 'handDrawnCirclev2',
      'binderClip', 'pushpin',
      'fullBodyCat', 'fullBodyDog', 'boyCharacter', 'girlCharacter',
      'coffeeCup', 'flower',
    ],
    maxEmoji: 1,
    maxDoodle: 2,
  ...
  comic: {
    categories: ['3d', 'effect', 'emoji', 'decor', 'burst', 'hot', 'energy', 'character', 'animal', 'food'],
    preferred: [
      ...
      'sparkleEyes', 'angryFace', 'shockedFace', 'loveEyes',
      'boyCharacter', 'girlCharacter', 'fullBodyCat', 'fullBodyDog',
    ],
    maxEmoji: 4,
    maxDoodle: 1,
  },
